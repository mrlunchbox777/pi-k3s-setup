...
show_variables() {
  ...
  variablesArray+=( "" )
  variablesArray+=( "skip_del_initial_user=$skip_del_initial_user" )
  variablesArray+=( "  optional" )
  variablesArray+=( "  -sdiu/--skip_del_initial_user" )
  ...
  variablesArray+=( "" )
  variablesArray+=( "initial_target_hostname=$initial_target_hostname" )
  variablesArray+=( "  optional" )
  variablesArray+=( "  -ith/--initial_target_hostname" )
  variablesArray+=( "  desc: the initial hostname for the target, default value is value of hostname" )
  variablesArray+=( "" )
